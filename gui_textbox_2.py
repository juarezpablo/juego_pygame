...
class TextBox_2(Widget_2):
    def __init__(self,master,x=0,y=0,w=200,h=50,color_background=C_GREEN_2,color_border=C_RED,image_background=None,text="Button",font="Arial",font_size=14,font_color=C_BLUE,on_click=None,on_click_param=None):
