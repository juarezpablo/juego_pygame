...
class Formulario_level_3(Form):
    ...
    def update(self,delta_ms,lista_eventos,player_1,tablero_de_gestion):
        ...
        if self.bandera_nivel ==0:
            tablero_de_gestion.stage_3.active=True
            self.bandera_nivel=1
        if tablero_de_gestion.stage_3.active and tablero_de_gestion.stage_3.derrota==False:
            tablero_de_gestion.stage_3.update(delta_ms,player_1.municion_list,player_1)
            
        elif tablero_de_gestion.stage_3.active==False:
            print("FIN")
            self.bandera_player_reset=0
            self.menu("form_alias")    
        elif tablero_de_gestion.stage_3.derrota:
            tablero_de_gestion.stage_3.active=False
            tablero_de_gestion.stage_3.derrota=False
            self.menu("form_derrota")
        player_1.update(delta_ms,tablero_de_gestion.stage_3.lista_plataformas,tablero_de_gestion) 

    def draw(self,delta_ms,player_1,tablero_de_gestion):
    
        tablero_de_gestion.stage_3.draw(tablero_de_gestion.master_surface,player_1.municion_list)
